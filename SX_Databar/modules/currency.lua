...
honorFrame:SetScript("OnEnter", function()
	...
	GameTooltip:AddLine(" ")
	--local concName, concAmount, _, concEarnedThisWeek, concWeeklyMax, concTotalMax, concIsDiscovered = GetCurrencyInfo(43308)
	local honorName, honorAmount, _, honorEarnedThisWeek, honorWeeklyMax, honorTotalMax, honorIsDiscovered = GetCurrencyInfo(43308)
